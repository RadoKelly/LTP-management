...
?>
    <div class="container voir">
        <header>Informations personnel</header>
                ...
                <div class="details personal" >
                    ...
                    <div class="fields">
                        <div class="input-field">
                            ...
                            <input disabled type="text" name="nom" placeholder="Entrer le nom" required value="<?php echo $eleve->getNom(); ?>">
                        </div>

                        <div class="input-field">
                            <label >Prenom</label>
                            <input disabled type="text" name="prenom" placeholder="Entrer le Prenom" required value="<?php echo $eleve->getPrenom(); ?>">
                        </div>
                        
                        <div class="input-field">
                            <label for="name">Date de naissance</label>
                            <input disabled type="date" name="date_naissance" placeholder="Entrer la date de naissance" required value="<?php echo $eleve->getDate_naissance(); ?>">
                        </div>
                        
                        <div class="input-field">
                            <label for="name">N°</label>
                            <input disabled type="text" name="numero" placeholder="Numero" required value="<?php echo $eleve->getNumero(); ?>">
                        </div>

                        <div class="input-field">
                            <label >N° Matricule</label>
                            <input disabled type="text" name="matricule" placeholder="Entrer le Matricule" required value="<?php echo $eleve->getMatricule(); ?>">
                        </div>

                        <div class="input-field">
                            <label for="sexe">Sexe</label>
                            <select name="sexe" id="sexe"  disabled>
                        ...
                        <div class="input-field">
                            <label>Contact</label>
                            <input disabled type="text" name="contact" placeholder="Entrer le contact" required value="<?php echo $eleve->getContact(); ?>">
                        </div>

                        <div class="input-field">
                            <label >Address</label>
                            <input disabled type="text" name="address" placeholder="Entrer l'address" required value="<?php echo $eleve->getAddress(); ?>">
                        </div>

                        <div class="input-field">
                        <label for="inscription">Année Scolaire</label>
                            <select disabled name="inscription" id="sexe">
                        ...
                        <div class="input-field">
                        <label for="inscription">Observation</label>
                            <select disabled name="inscription" id="sexe">
                        ...
                        <div class="input-field">
                            ...
                            <select disabled name="secteur" id="secteur">
                        ...
                        <div class="input-field">
                            ...
                            <select disabled name="filiere" id="filiere">
                        ...
                        <div class="input-field">
                            ...
                            <select disabled name="niveau" id="niveau">
