<?php
    ...
    if (isset($_POST['num']) && isset($_POST['malagasy']) && isset($_POST['francais']) && isset($_POST['anglais']) && isset($_POST['math']) &&
        ...
        $matiere = new DemModel(null,$_POST['num'],$_POST['malagasy'], $_POST['francais'], $_POST['anglais'], $_POST['math'],
        ...
        $verificationMatiere = $contro->InsertionNoteDEM($matiere);
        $dem = $contro->RecupererNoteDEMTrim($numMatricule,$trimestre);
        // $sphy = $el->getSphys();
        ...
        $rang = 1;
        $LeMoyenne = new MoyenneDem();
        $moyenne = $LeMoyenne->Dem($dem);
